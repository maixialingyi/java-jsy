package com.jsy.learn.io.nettyRpc.rpcenv.serverenv;

import com.jsy.learn.io.nettyRpc.discover.MyDiscover;
import com.jsy.learn.io.nettyRpc.rpcenv.DecodeHandler;
...
public class ServerRPCEnv {
    ...
    public static void startServer(){
        ...
        MyDiscover.register(IUserApi.class,new InetSocketAddress("localhost",9090));
